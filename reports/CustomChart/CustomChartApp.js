Ext.define('CustomChartApp', {
    ...
    // Returns settings fields from top-level Rally app settings
    ...
    // Assert model type for this app
    ...
    _addChart: function() {
        var context = this.getContext(),
            ...
            gridBoardConfig = {
                ...
                plugins: [{
                    // Built-in filter control for app user
                ...
                { // Built-in option button to export to csv
    ...
    // Rally App filter header for commonly requested filters for the user
    _getQuickFilters: function() {
        ...
        var temp = _.filter(quickFilters, function(quickFilter) {
            return model.hasField(quickFilter);
        });

        console.log('quickfilters', temp);
        return temp;
    },
    ...
    // Returns an array of labels and field(s) for organizing data
    ...
    // Defined to sort chart fields in ascending order
